...
public class YearAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final String TAG = YearAdapter.class.getSimpleName();
    ...
    public YearAdapter(Activity activity, OnRecyclerViewClick mOnRecyclerViewClick) {
        mActivity = activity;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_year,
                parent, false);
        ...
        try {
            ...
            if (data != null) {
                ...
                if (data.isCheck()){
                    ...
                    viewHolder.textItemName.setBackground(ContextCompat.getDrawable(mActivity, R.drawable.rounded_corner_check));
                }else {
                    viewHolder.textItemName.setTextColor(ContextCompat.getColor(mActivity, R.color.colorTextSecond));
                    viewHolder.textItemName.setBackground(ContextCompat.getDrawable(mActivity, R.drawable.rounded_corner));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            rootView = itemView.findViewById(R.id.rootViewYear);
